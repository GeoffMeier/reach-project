...
def food_score_calc(calorie_target, calories_consumed):
    if  calorie_target <= 0:
        return 0
    
    calc_score = int((calories_consumed / calorie_target) * 10000)
...
def mealmenu(username):
    global calories_consumed, p_tot, f_tot, c_tot
    while True:
